...
namespace cg {
    namespace {
        ...
        cg::Vec2d scrollDeltaNew(0, 0), scrollDeltaOld(0, 0), mousePosOld;
    };
    ...
    bool IsKeyUp(int key) { return !cg::IsKeyDown(key); }
    ...
    bool IsMouseButtonUp(int button) { return !cg::IsMouseButtonDown(button); }
    ...
    cg::Vec2d GetMouseDelta(){
        return cg::GetMousePos() - mousePosOld;
    }
