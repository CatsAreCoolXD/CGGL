...
#define KEY_DOT GLFW_KEY_PERIOD
...
#define INPUTSTATE_PRESSED 0
#define INPUTSTATE_DOWN 1
#define INPUTSTATE_RELEASED 2
...
#define IsKeyReleased(key) IsKeyUp(key)
#define GetKeyPressed(key) GetKeyDown(key)
#define GetKeyReleased(key) GetKeyUp(key)

#define IsMouseButtonPressed(button) IsMouseButtonDown(button)
#define IsMouseButtonReleased(button) IsMouseButtonUp(button)
#define GetMouseButtonPressed(button) GetMouseButtonDown(button)
#define GetMouseButtonReleased(button) GetMouseButtonUp(button)
